...
def test_glm5_next_conditional_model_surfaces_text_packed_lora_modules():
    """The deployed multimodal architecture must expose text fusion metadata."""
    assert supports_lora(Glm5NextForConditionalGeneration)
    assert Glm5NextForConditionalGeneration.packed_modules_mapping == {
